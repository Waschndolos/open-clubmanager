            ...
            <Dialog open onClose={onClose} maxWidth="md" fullWidth>
                ...
                <DialogContent>
                    ...
                    <Grid container spacing={2}>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.number")}
                        ...
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.firstName")}
                                                                value={formData.firstName ?? ''}
                                                                onChange={(e) => handleChange("firstName", e.target.value)}/></Grid>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.lastName")}
                        ...
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.comment")}
                                                                value={formData.comment ?? ''}
                                                                onChange={(e) => handleChange("comment", e.target.value)}/></Grid>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.phone")}
                                                                value={formData.phone ?? ''}
                                                                onChange={(e) => handleChange("phone", e.target.value)}/></Grid>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.phoneMobile")}
                    ...
                    <Grid container spacing={2}>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.street")}
                                                                value={formData.street ?? ''}
                                                                onChange={(e) => handleChange("street", e.target.value)}/></Grid>
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.postalCode")}
                        ...
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.state")}
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid size={{xs: 12, sm: 6}}><TextField fullWidth label={t("members.table.header.bankName")}
